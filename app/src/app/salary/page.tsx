...
export default function ManualSalaryPage() {
  ...
  return (
    <main className="p-6 max-w-5xl mx-auto space-y-10">
      <h1 className="text-2xl font-bold mb-2">💵 인건비 직접입력 + 조회</h1>
      ...
      {branch && (
        <section className="border rounded-lg p-4 bg-white space-y-4">
          <div className="flex justify-between items-center">
            ...
            <button onClick={addRow} className="bg-blue-600 text-white px-3 py-1 rounded">+ 행 추가</button>
          </div>
            ...
            <table className="w-full text-sm border">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="border p-2 text-right">월매출</th> {/* ✅ 추가 */}
                ...
                {rows.map((r, i) => (
                  <tr key={i} className="border-t">
                    ...
                    <td className="p-2 text-center">
                      <button className="text-red-600 underline text-xs" onClick={() => removeRow(i)}>삭제</button>
                    </td>
                  </tr>
                ))}
              </tbody>
                  ...
                  <table className="w-full text-sm border">
                    <thead className="bg-gray-100">
                      <tr>
                        ...
                        <th className="border p-2 text-right">총급여</th>
                        <th className="border p-2">삭제</th> {/* ✅ 추가 */}
                      </tr>
                    </thead>
                    <tbody>
                      {listRows.map((r, i) => (
